...
class TaskInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["result", b"result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["enqueued_at", b"enqueued_at", "finished_at", b"finished_at", "id", b"id", "result", b"result", "started_at", b"started_at", "task_type", b"task_type"]) -> None: ...
